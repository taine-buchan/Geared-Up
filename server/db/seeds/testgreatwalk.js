export async function seed(knex) {
  await knex('great_walks').insert([
    ...
    elevation:”The highest point is Bald Knob at 1,161 meters (3,809 feet), located on Panekire Bluff.”,
    duration: “3–4 days”,
    distance: “46 km one way”,
    location: “Te Urewera, East North Island”,
    description:”Lake Waikaremoana is a Great Walk that is more of a backcountry, off the beaten track experience. Be immersed into stunning natural wilderness and welcomed into the homeland of Ngai Tūhoe.",
    seasonal:”All year”,
    track_image_url : https://www.hawkesbaynz.com/assets/HBT-See-and-Do/Rivers-Lakes-Waterfalls/HBT-SeeDo-Recreations-RiversLakesWaterfalls-LakeWaikaremoana-Banner-1600x650.jpg "
    doc_link: “https://www.doc.govt.nz/parks-and-recreation/places-to-go/east-coast/places/te-urewera/things-to-do/tracks/lake-waikaremoana-great-walk/ “
    required_equipment: "{
      "backpack": true,
    ...
    name:Heaphy Track,
    difficulty:”Intermediate”,
    elevation:”The track traverses a wide range of elevations, reaching a high point in the sub-alpine tussock grasslands, around 1,075 meters (3,527 feet).”
    duration: 4–6 days,
    distance: 78.4 km one way,
    location: Kahurangi National Park, north-west South Island,
    description:”If it’s varied and rugged landscapes you’re looking for, you’ll be spoilt for choice on the Heaphy Track. Retrace the steps of early Māori seeking pounamu (greenstone) and 19th century gold prospectors. You’ll pass through expansive tussock downs, lush forests and nīkau palms before reaching the roaring seas of the West Coast.”
    seasonal : All year,
    track_image_url : https://holidayswithkids.com.au/wp-content/uploads/2018/10/7128_Honeycomb_Hill_Caves_Julian_Apse.jpg
    doc_link: “https://www.doc.govt.nz/parks-and-recreation/places-to-go/nelson-tasman/places/kahurangi-national-park/things-to-do/tracks/heaphy-track/
    ”
    required_equipment: “{
      "backpack": true,
      "waterproof_pack_liner": true,
    ...
    name:Miford Track,
    difficulty:”Easy”,
    elevation:”The highest point is Mackinnon Pass at 1,069 meters (3,507 feet).”
    duration: 4 days,
    distance: 53.5 km,
    location: Fiordland National Park, south-west South Island,
    description:”Experience the ‘finest walk in the world’ as you retrace the steps of early explorers on the world renowned Milford Track. Take a journey along valleys carved by glaciers, wander through ancient rainforests and admire cascading waterfalls. You’ll follow a historic route through Fiordland National Park, part of Te Wāhipounamu – South West New Zealand World Heritage Area, before reaching your final destination, the spectacular Milford Sound/Piopiotahi.”,
    ...
    difficulty:”Intermediate”,
    elevation:”This newer Great Walk reaches a high point of around 1,000 meters (3,281 feet) near Okaka Lodge in the subalpine zone.”
    duration: 3 days,
    distance: 60 km loop,
    location: Southern Fiordland,
    description:”Experience stunning beach, forest and mountain views on the Tuatapere Hump Ridge Track.”
    seasonal:All year,
    track_image_url : 
